...
// ownProps, what is passed in to the component as the parameter
const mapDispatchToProps = (dispatch, ownProps) => {
  const {id, amount} = ownProps

  // cant just be dispatch() must be a function define because you want user click it and then update
  // type: what kind of actions should we take, payload to whom/what should we take the action
  return { 
